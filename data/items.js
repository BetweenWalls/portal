...
{name:"Moonfire", type:"quiver", req_level:21, ar_bonus:15, mDamage_reduced:4, extra_conversion_Magic_Arrow:10, extra_arrows_Magic_Arrow:2, pod_changes:1},
    ...
    charms: [
{name:"Charms"},
{name:"Annihilus", size:"small", req_level:80, all_skills:1, all_attributes:20, all_res:20, experience:10, pod:1},
{name:"Hellfire Torch", size:"large", req_level:75, skills_class:3, all_attributes:20, all_res:20, light_radius:8, pod_changes:1, pod:1},
...
{rarity:"magic", name:"Serpent's Small Charm of Vita", size:"small", req_level:40, mana:17, life:20, pod:1},
{rarity:"magic", name:"Shimmering Small Charm of Inertia", size:"small", req_level:36, all_res:5, frw:3, pod:1},
{rarity:"magic", name:"Shimmering Small Charm of Good Luck", size:"small", req_level:33, all_res:5, mf:7, pod:1},
{rarity:"magic", name:"Shimmering Small Charm of Vita", size:"small", req_level:39, all_res:5, life:20, pod:1},
{rarity:"magic", name:"Ruby Small Charm of Vita", size:"small", req_level:39, fRes:11, life:20, pod:1},
{rarity:"magic", name:"Sapphire Small Charm of Vita", size:"small", req_level:39, cRes:11, life:20, pod:1},
{rarity:"magic", name:"Amber Small Charm of Vita", size:"small", req_level:39, lRes:11, life:20, pod:1},
{rarity:"magic", name:"Emerald Small Charm of Vita", size:"small", req_level:39, pRes:11, life:20, pod:1},
{rarity:"magic", name:"Fine Small Charm of Balance", size:"small", req_level:29, damage_max:3, ar:20, fhr:5, pod:1},
{rarity:"magic", name:"Fine Small Charm of Inertia", size:"small", req_level:36, damage_max:3, ar:20, frw:3, pod:1},
{rarity:"magic", name:"Pestilent Small Charm of Anthrax", size:"small", req_level:80, pDamage_all:451, pDamage_duration:12, pod:1},
{rarity:"magic", name:"Fine Small Charm of Vita", size:"small", req_level:39, damage_max:3, ar:20, life:20, pod:1},
{rarity:"magic", name:"Sharp Large Charm of Vita", size:"large", req_level:66, damage_max:6, ar:48, life:35, pod:1},
{rarity:"magic", name:"Sharp Grand Charm of Vita", size:"grand", req_level:83, damage_max:10, ar:76, life:45, pod:1},
...
{debug:1, name:"+1 skill (fire)", req_level:100, skills_fire_all:1},
{debug:1, name:"+1 skill (cold)", req_level:100, skills_cold_all:1},
{debug:1, name:"+1 skill (lightning)", req_level:100, skills_lightning_all:1, pd2:1},
{debug:1, name:"+1 skill (poison)", req_level:100, skills_poison_all:1},
{debug:1, name:"+1 skill (magic)", req_level:100, skills_magic_all:1, pd2:1},
...
{debug:1, only:"amazon", name:"+1 skill (javelin/spear)", req_level:100, skills_javelins:1},
{debug:1, only:"amazon", name:"+1 skill (passive/magic)", req_level:100, skills_passives:1},
{debug:1, only:"amazon", name:"+1 skill (bow/crossbow)", req_level:100, skills_bows:1},
{debug:1, only:"assassin", name:"+1 skill (martial arts)", req_level:100, skills_martial:1},
{debug:1, only:"assassin", name:"+1 skill (shadow disciplines)", req_level:100, skills_shadow:1},
{debug:1, only:"assassin", name:"+1 skill (traps)", req_level:100, skills_traps:1},
{debug:1, only:"barbarian", name:"+1 skill (warcries)", req_level:100, skills_warcries:1},
{debug:1, only:"barbarian", name:"+1 skill (combat masteries)", req_level:100, skills_masteries:1},
{debug:1, only:"barbarian", name:"+1 skill (combat skills)", req_level:100, skills_combat_barbarian:1},
...
{debug:1, only:"paladin", name:"+1 skill (defensive auras)", req_level:100, skills_defensive:1},
{debug:1, only:"paladin", name:"+1 skill (offensive auras)", req_level:100, skills_offensive:1},
{debug:1, only:"paladin", name:"+1 skill (combat)", req_level:100, skills_combat_paladin:1},
{debug:1, only:"sorceress", name:"+1 skill (cold spells)", req_level:100, skills_cold:1},
{debug:1, only:"sorceress", name:"+1 skill (lightning spells)", req_level:100, skills_lightning:1},
{debug:1, only:"sorceress", name:"+1 skill (fire spells)", req_level:100, skills_fire:1},
{debug:1, name:"-1% ias", req_level:100, ias:-1, pod:1},
{debug:1, name:"+1% ias", req_level:100, ias:1, pod:1},
{debug:1, name:"+5% ias", req_level:100, ias:5, pod:1},
{debug:1, name:"-1% fcr", req_level:100, fcr:-1, pod:1},
{debug:1, name:"+1% fcr", req_level:100, fcr:1, pod:1},
{debug:1, name:"+5% fcr", req_level:100, fcr:5, pod:1},
{debug:1, name:"-1% fbr", req_level:100, fbr:-1, pod:1},
{debug:1, name:"+1% fbr", req_level:100, fbr:1, pod:1},
{debug:1, name:"+5% fbr", req_level:100, fbr:5, pod:1},
{debug:1, name:"-1% fhr", req_level:100, fhr:-1, pod:1},
{debug:1, name:"+1% fhr", req_level:100, fhr:1, pod:1},
{debug:1, name:"+5% fhr", req_level:100, fhr:5, pod:1},
{debug:1, name:"+1% fire", req_level:100, fDamage:1},
{debug:1, name:"+5% fire", req_level:100, fDamage:5},
{debug:1, name:"+10% fire", req_level:100, fDamage:10},
{debug:1, name:"+20% fire", req_level:100, fDamage:20},
{debug:1, name:"+1% cold", req_level:100, cDamage:1},
{debug:1, name:"+5% cold", req_level:100, cDamage:5},
{debug:1, name:"+10% cold", req_level:100, cDamage:10},
{debug:1, name:"+20% cold", req_level:100, cDamage:20},
{debug:1, name:"+1% lightning", req_level:100, lDamage:1},
